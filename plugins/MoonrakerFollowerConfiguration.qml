                ...
                Flickable {
                    ...
                    Column {
                        ...
                        UM.CheckBox {
                            ...
                            checked: manager.settingsUploadStartPrint
                        }
                        UM.CheckBox {
                        ...
                        UM.CheckBox {
                            ...
                            checked: manager.settingsUploadAutohideMessage
                        }
                        ...
                        Cura.TextField {
                            ...
                            width: parent.width
                            text: manager.settingsPowerDevices
                            maximumLength: 1024
                        }
                        UM.Label {
                        ...
                        Cura.TextField {
                            ...
                            maximumLength: 256
                            onTextChanged: base.validTranslation = manager.validTranslation(text, translateOutputField.text)
                        }
                        Cura.TextField {
                            ...
                            maximumLength: 256
                            onTextChanged: base.validTranslation = manager.validTranslation(translateInputField.text, text)
                        }
                        Cura.TextField {
