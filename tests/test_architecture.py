...
class SourceContractTests(unittest.TestCase):
    ...
    def test_components_import_only_their_declared_dependencies(self):
        allowed = {
            ...
            "MoonrakerMonitorModel": {"ConsoleController", "FileManager", "FileManagerPolicy", "MonitorCamera", "MonitorCommands", "MonitorControls", "MonitorData", "MonitorFormatting", "MonitorPermissions", "MonitorTemperatureHistory", "MonitorTuning", "PrinterConfig", "ToolheadController", "ToolheadPolicy", "WhatsNew"},
