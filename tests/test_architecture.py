...
class SourceContractTests(unittest.TestCase):
    ...
    def test_components_import_only_their_declared_dependencies(self):
        allowed = {
            ...
            "PrintCoordinator": {"CuraAdapter", "LoadStateTracker", "MonitorFormatting", "NextPausePipeline", "PlateProgress", "PreviewFormatting", "PrintIdentity", "PrintState", "RemoteJobService"},
            "PrintIdentity": set(),
