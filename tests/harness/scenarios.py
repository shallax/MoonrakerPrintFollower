...
SCENARIOS = [
    ...
    # ─── V: visual fidelity — alignment, pane exercise, rendered-follows ───
    {"id": "v1", "group": "v",
     ...
     "steps": [
         ...
         {"op": "gap_between", "above": {"objectName": "postProcessingSaveAreaButton"},
          "below": {"objectName": "moonrakerPreviewActionPanelControls"}, "edges": "bottoms",
          "min": -4, "max": 4},
